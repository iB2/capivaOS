...
- Agent roles (dev, qa, arch, gate-judge, phase-runner, context-answerer) — dev/qa/arch reference the active blueprint for stack-specific patterns; gate-judge and phase-runner serve the ADR-0014 autonomy layer; the opt-in context-answerer serves the ADR-0017 batch-refine layer
